...
<html lang="zh-Hant-TW">
    ...
    <body>
            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading">訂單明細<br>
                                               ...
                                               案名：<?php echo $clientName[0]['clientName'];?><br>
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        for($n=0;$n<$count_page;$n++){ ?>    
                                            <tr class="odd gradeX">
                                                <td>
                                                    <button type="button" class="btn-primary" data-toggle="modal" data-target="#myModal<?php echo $show_paging[$n]['productID'];?>">
                                                        修改
                                                    </button> 
                                                    <button type="button" class="btn-danger" data-toggle="modal" data-target="#deleteDetail<?php echo $show_paging[$n]['productID'];?>">
                                                        刪除
                                                    </button>     
                                                </td>
                                                <td><?php echo $show_paging[$n]['productID']?></td>
                                                <td><?php echo $show_paging[$n]['productName']?></td>
                                                <td><?php echo $show_paging[$n]['quantity']?></td>
                                            </tr>
                                    <?php } ?> 
                                </tbody>
                            </table>
        ...
        <?php
            ...
            <!-- 修改明細的Modal -->
            <div class="modal fade" id="myModal<?php echo $show_update_modal[$j]['productID'];?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                        ...
                        <form method="post" action="">
                            ...
                            <div class="modal-body">    
                                <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td><?php echo $show_update_modal[$j]['productID'];?></td>
                                            <td><?php echo $show_update_modal[$j]['productName'];?></td>
                                            <td>
                                                <!--<button type="submit" class="btn btn-default" aria-label="Left Align" name="plus_quantity">-->
                                                <!--    <span class="glyphicon glyphicon-minus-sign" aria-hidden="true"></span>-->
                                                <!--</button>-->
                                                <input type="text" name="update_quantity" value="<?php echo $show_update_modal[$j]['quantity'];?>"></input>
                            ...
                            <div class="modal-footer">
                                <input style="visibility:hidden" name="update_productID" value="<?php echo $show_update_modal[$j]['productID'];?>"/>
        ...
        <?php 
            ...
            <!-- 刪除明細的Modal -->
            <div class="modal fade bs-example-modal-sm" id="deleteDetail<?php echo $show_delete_modal[$k]['productID'];?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                <div class="modal-dialog">
                    <div class="modal-content">
                        <form method="post" action="../controllers/actionDetail.php">
                            ...
                            <div class="modal-body">
                                商品編號：<?php echo $show_delete_modal[$k]['productID'];?><br>
                                品名：<?php echo $show_delete_modal[$k]['productName'];?><br>
                                數量：<?php echo $show_delete_modal[$k]['quantity'];?>
                            </div>
                            <div class="modal-footer">
                                <input style="visibility:hidden" name="delete_orderformID" value="<?php echo $orderform;?>"/>
                                <input style="visibility:hidden" name="delete_productID" value="<?php echo $show_delete_modal[$k]['productID'];?>"/>
                    ...
                    <form method="post" action="../controllers/actionDetail.php">
                        ...
                        <div class="modal-body">
                            <table class="table table-striped table-bordered table-hover" id="dataTables-example">
                                    ...
                                    <tbody>
                                        <?php for($h=0;$h<$list;$h++){?>
                                        <tr>
                                            <td>    
                                                <input type="checkbox" value="<?php echo $show_list[$h]['productID'];?>" name="product[]"><?php echo $show_list[$h]['productName'];?>
                                            </td>
                                            <td>
                        ...
                        <div class="modal-footer">
                            ...
                            <input style="visibility:hidden" name="insert_clientID" value="<?php echo $clientName[0]['clientID'];?>"/>
